                ...
                <div class="p-8 lg:p-10">
                    <div class="mb-6">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <div class="flex flex-col sm:flex-row items-center justify-center gap-3 mb-1">
                                ...
                                <a
                                    ...
                                    class="inline-flex items-center gap-2 font-sans text-xs font-medium text-white bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-sm transition-colors shadow-md hover:shadow-lg"
                                >
